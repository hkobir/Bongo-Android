    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_fullscreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag)
                {
                    btn_fullscreen.setImageDrawable(getResources().getDrawable(R.drawable.ic_fullscrenn));
                    setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                    flag=false;
                }
                else
                {
                    btn_fullscreen.setImageDrawable(getResources().getDrawable(R.drawable.ic_full_out));
